...
El error habitual es aplanar todos los valores en un único `some`, lo que devuelve productos que cumplen _cualquiera_ de los filtros en vez de todos.
...
**Detalle que se olvida:** el registro en `Inquiry` debe ocurrir _antes_ de abrir WhatsApp y no debe bloquear la navegación. Si la escritura falla, el usuario igual llega a WhatsApp.
